...
function validateAntinodes(array, height, width) {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    for (let node of otherNodes) {
      ...
      while (true) {
        firstAntinode = [
          firstAntinode[0] + heightAway,
          firstAntinode[1] + widthAway,
        ];
      ...
      while (true) {
        secondAntinode = [
          secondAntinode[0] + heightAway,
          secondAntinode[1] + widthAway,
        ];
        if (
          extendNodes(secondAntinode, -heightAway, -widthAway, height, width)
        ) {
